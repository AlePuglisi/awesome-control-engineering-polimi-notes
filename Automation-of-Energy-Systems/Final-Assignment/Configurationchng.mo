model Configurationchng
  ...
  Modelica.Blocks.Logical.Switch switch annotation(
    Placement(visible = true, transformation(origin = {246, 140}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.TransferFunction Cp3B(a = {1}, b = {184012/61875/5}) annotation(
    Placement(visible = true, transformation(origin = {-260, 156}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Add add annotation(
    Placement(visible = true, transformation(origin = {-218, 144}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(switch.u2, Bconfig.y) annotation(
    Line(points = {{236, 140}, {160, 140}, {160, 44}, {-376, 44}}, color = {255, 0, 255}));
  ...
  connect(fb3.u, switch.y) annotation(
    Line(points = {{-78, 122}, {294, 122}, {294, 140}, {255, 140}}, color = {0, 0, 127}));
  ...
  connect(Cp3B.y, add.u1) annotation(
    Line(points = {{-249, 156}, {-240.5, 156}, {-240.5, 150}, {-230, 150}}, color = {0, 0, 127}));
  ...
  connect(beta3B.y, add.u2) annotation(
    Line(points = {{-270, 100}, {-286, 100}, {-286, 138}, {-230, 138}}, color = {0, 0, 127}));
  ...
  connect(N_B.y, switch.u1) annotation(
    Line(points = {{239, 42}, {236, 42}, {236, 146}}, color = {0, 0, 127}));
  connect(N_IsA.y, switch.u3) annotation(
    Line(points = {{133, 152}, {166, 152}, {166, 134}, {236, 134}}, color = {0, 0, 127}));
  connect(add.y, switch6.u1) annotation(
    Line(points = {{-207, 144}, {-196, 144}, {-196, 188}, {-184, 188}}, color = {0, 0, 127}));
  ...
  connect(switch11.y, Cp3B.u) annotation(
    Line(points = {{-288, 156}, {-272, 156}}, color = {0, 0, 127}));
