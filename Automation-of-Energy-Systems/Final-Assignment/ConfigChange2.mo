model ConfigChange2
  ...
  Modelica.Blocks.Math.Gain beta3A(k = 0.02104/0.016) annotation(
    Placement(visible = true, transformation(origin = {42, 124}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Math.Product product111 annotation(
    Placement(visible = true, transformation(origin = {40, 96}, extent = {{-4, -4}, {4, 4}}, rotation = -90)));
  Modelica.Blocks.Math.Add add41 annotation(
    Placement(visible = true, transformation(origin = {23, 79}, extent = {{-5, -5}, {5, 5}}, rotation = -90)));
  ...
  Modelica.Blocks.Math.Gain J12A(k = 1/10^4) annotation(
  ...
  Modelica.Blocks.Math.Add GEN3A annotation(
  ...
  Modelica.Blocks.Math.Add GENTOTBor12A annotation(
    Placement(visible = true, transformation(origin = {367, 97}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.Product product4 annotation(
    Placement(visible = true, transformation(origin = {342, 88}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Math.Gain gain(k = 1/(30*10^3)) annotation(
    Placement(visible = true, transformation(origin = {310, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Gain gain1(k = 1/(40*10^3)) annotation(
    Placement(visible = true, transformation(origin = {312, 120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Product product5 annotation(
    Placement(visible = true, transformation(origin = {340, 116}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Product product7 annotation(
    Placement(visible = true, transformation(origin = {156, 216}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Product product8 annotation(
    Placement(visible = true, transformation(origin = {122, 168}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Math.Add add8 annotation(
    Placement(visible = true, transformation(origin = {149, 149}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.Product product9 annotation(
    Placement(visible = true, transformation(origin = {124, 140}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Gain gain2(k = -1) annotation(
    Placement(visible = true, transformation(origin = {14, -256}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
...
equation
  ...
  connect(add3.y, g3.u) annotation(
    Line(points = {{17, 26}, {38, 26}}, color = {0, 0, 127}));
  ...
  connect(beta3B.y, product1111.u2) annotation(
    Line(points = {{4, 116}, {4, 106}, {8, 106}, {8, 102}}, color = {0, 0, 127}));
  connect(beta3A.y, product111.u1) annotation(
    Line(points = {{42, 114}, {42, 101}}, color = {0, 0, 127}));
  connect(product1111.y, add41.u2) annotation(
    Line(points = {{10, 94}, {10, 90}, {20, 90}, {20, 86}}, color = {0, 0, 127}));
  connect(product111.y, add41.u1) annotation(
    Line(points = {{40, 92}, {40, 88}, {26, 88}, {26, 86}}, color = {0, 0, 127}));
  connect(add41.y, add3.u1) annotation(
    Line(points = {{24, 74}, {22, 74}, {22, 56}, {-6, 56}, {-6, 32}}, color = {0, 0, 127}));
  ...
  connect(Cs.y, beta3A.u) annotation(
    Line(points = {{-255, 188}, {4, 188}, {4, 146}, {42, 146}, {42, 136}}, color = {0, 0, 127}));
  ...
  connect(add51.y, add3.u2) annotation(
    Line(points = {{-216, 30}, {-12, 30}, {-12, 20}, {-6, 20}}, color = {0, 0, 127}));
  ...
  connect(product312.y, GEN3A.u2) annotation(
    Line(points = {{364, -76}, {372, -76}, {372, -70}, {379, -70}}, color = {0, 0, 127}));
  connect(product1213.y, GEN3A.u1) annotation(
  ...
  connect(gain.y, product4.u2) annotation(
    Line(points = {{321, 84}, {332, 84}, {332, 86}, {337, 86}}, color = {0, 0, 127}));
  connect(product5.y, GENTOTBor12A.u1) annotation(
    Line(points = {{344.4, 116}, {356.4, 116}, {356.4, 100}, {361.4, 100}}, color = {0, 0, 127}));
  connect(gain1.y, product5.u1) annotation(
    Line(points = {{323, 120}, {329, 120}, {329, 118}, {335, 118}}, color = {0, 0, 127}));
  connect(product4.y, GENTOTBor12A.u2) annotation(
    Line(points = {{346.4, 88}, {354.4, 88}, {354.4, 94}, {361.4, 94}}, color = {0, 0, 127}));
  connect(product12141.y, gain.u) annotation(
    Line(points = {{224, 94}, {280, 94}, {280, 84}, {298, 84}}, color = {0, 0, 127}));
  connect(product12141.y, gain1.u) annotation(
    Line(points = {{224, 94}, {280, 94}, {280, 120}, {300, 120}}, color = {0, 0, 127}));
  connect(GEN3A.y, fb.u) annotation(
  ...
  connect(product7.y, add7.u2) annotation(
    Line(points = {{160.4, 216}, {168.4, 216}, {168.4, 222}, {175.4, 222}}, color = {0, 0, 127}));
  connect(Pe34.y, product6.u1) annotation(
    Line(points = {{92, 250}, {142, 250}, {142, 246}, {150, 246}}, color = {0, 0, 127}));
  connect(Pe12.y, product7.u2) annotation(
    Line(points = {{92, 218}, {144, 218}, {144, 214}, {152, 214}}, color = {0, 0, 127}));
  connect(add7.y, Pbal.u2) annotation(
    Line(points = {{186, 226}, {210, 226}, {210, 122}, {198, 122}, {198, -34}}, color = {0, 0, 127}));
  connect(product8.y, add8.u1) annotation(
    Line(points = {{126.4, 168}, {138.4, 168}, {138.4, 152}, {143.4, 152}}, color = {0, 0, 127}));
  connect(product9.y, add8.u2) annotation(
    Line(points = {{128.4, 140}, {136.4, 140}, {136.4, 146}, {143.4, 146}}, color = {0, 0, 127}));
  connect(add8.y, pbal.u2) annotation(
    Line(points = {{154, 150}, {174, 150}, {174, 106}}, color = {0, 0, 127}));
  connect(Pe34.y, product8.u1) annotation(
    Line(points = {{92, 250}, {108, 250}, {108, 170}, {118, 170}}, color = {0, 0, 127}));
  connect(Pe12.y, product9.u2) annotation(
    Line(points = {{92, 218}, {100, 218}, {100, 136}, {120, 136}, {120, 138}}, color = {0, 0, 127}));
  ...
  connect(booleanToReal.y, product1111.u1) annotation(
    Line(points = {{-482, 262}, {-28, 262}, {-28, 108}, {12, 108}, {12, 102}}, color = {0, 0, 127}));
  connect(booleanToReal.y, product6.u2) annotation(
    Line(points = {{-482, 262}, {50, 262}, {50, 240}, {150, 240}, {150, 242}}, color = {0, 0, 127}));
  connect(booleanToReal.y, product8.u2) annotation(
    Line(points = {{-482, 262}, {40, 262}, {40, 164}, {118, 164}, {118, 166}}, color = {0, 0, 127}));
  ...
  connect(gain2.u, GENTOTBor12A.y) annotation(
    Line(points = {{26, -256}, {444, -256}, {444, 98}, {372, 98}}, color = {0, 0, 127}));
  ...
  connect(booleanToReal.y, product5.u2) annotation(
    Line(points = {{-482, 262}, {328, 262}, {328, 114}, {336, 114}}, color = {0, 0, 127}));
  ...
  connect(add9.y, product111.u2) annotation(
    Line(points = {{-488, 119}, {-488, 88}, {-220, 88}, {-220, 66}, {60, 66}, {60, 106}, {38, 106}, {38, 100}}, color = {0, 0, 127}));
  connect(add9.y, product9.u1) annotation(
    Line(points = {{-488, 119}, {-488, 104}, {-230, 104}, {-230, 204}, {70, 204}, {70, 142}, {120, 142}}, color = {0, 0, 127}));
  connect(add9.y, product7.u1) annotation(
    Line(points = {{-488, 119}, {-488, 104}, {-230, 104}, {-230, 204}, {132, 204}, {132, 226}, {148, 226}, {148, 218}, {152, 218}}, color = {0, 0, 127}));
  connect(add9.y, product4.u1) annotation(
    Line(points = {{-488, 119}, {-488, 104}, {-230, 104}, {-230, 188}, {236, 188}, {236, 50}, {328, 50}, {328, 90}, {338, 90}}, color = {0, 0, 127}));
  ...
  connect(gain2.y, Kp3B.u) annotation(
    Line(points = {{4, -256}, {-338, -256}, {-338, 52}, {-288, 52}}, color = {0, 0, 127}));
  connect(gain2.y, transferFunction.u) annotation(
    Line(points = {{4, -256}, {-338, -256}, {-338, 12}, {-288, 12}}, color = {0, 0, 127}));
  annotation(
    uses(Modelica(version = "4.0.0")),
    Diagram(coordinateSystem(extent = {{-560, 280}, {460, -280}})),
    version = "");
end ConfigChange2;
